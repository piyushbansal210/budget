...
export default function FAQ(props) {
    ...
    const data = [
        ...
        {
            id: 7,
            question: "Is the Spend Sync Money tracker app free to use?",
            answer: "Yes! The Spend Sync Money Tracker App is totally free to use. If you are happy with the app experience do take the time to rate us on the Google Play Store or Apple Store. We equally welcome constructive feedback or recommendations to deliver better services. We act on such feedback promptly to improve the app and ourselves.",
        },
        {
            id: 8,
            question: "Can I export data on Excel?",
            answer: "Yes, you can export your monthly data to Excel. The app allows you to generate a CSV file of your data. You can also add a picture of a receipt if needed.",
        },
