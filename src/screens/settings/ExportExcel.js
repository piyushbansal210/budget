      ...
      <View style={styles.container}>
        ...
        <ScrollView contentContainerStyle={styles.middleContainer}>
          ...
          <Text style={styles.subHeader}>
            Get your financial track report on Excel for exclusive analysis and understanding of your spending habits.
          </Text>
          <View style={styles.checkBoxArea}>
            <CheckBox check={check} setCheck={setCheck} />
            <Text style={styles.checkBoText}>
              Do you really want to export or share your data?
            </Text>
          </View>
        </ScrollView>
